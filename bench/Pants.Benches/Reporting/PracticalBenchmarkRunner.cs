...
static class PracticalBenchmarkRunner
{
    ...
    public static int Run(string[] args)
    {
        ...
        if (scenarios.Count != 151 || scenarios.Distinct(StringComparer.Ordinal).Count() != scenarios.Count)
        {
            Console.Error.WriteLine(
                $"Practical inventory must contain 151 unique scenarios; discovered {scenarios.Count}.");
            return 1;
        }
