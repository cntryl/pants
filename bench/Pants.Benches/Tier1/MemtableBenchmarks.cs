...
public class MemtableBenchmarks : Tier1Benchmark
{
    ...
    ImmutableSortedDictionary<byte[], CellState> _memtable = null!;
    byte[] _putKey = null!;
    ...
    public void Setup()
    {
        ...
        {
            builder.Add(BenchmarkData.Key(index), new CellState(_value, index, null));
        }

        _memtable = builder.ToImmutable();
    ...
    [Benchmark]
    public void Put() => _memtable = _memtable.SetItem(_putKey, new CellState(_value, 10_000, null));
