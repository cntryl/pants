...
static class BuiltInCloudProviderValidator
{
        ...
        ImmutableArray<PantsCloudStorageRole> roles)
    {
        ...
        if (provider is null)
        {
            findings.Add(Failure(
                PantsCloudProviderId.S3Compatible,
                roles,
        ...
        switch (provider)
        {
            case PantsAwsS3Provider aws:
                ValidateAws(findings, roles, aws);
                break;
            case PantsS3CompatibleProvider compatible:
                ValidateS3Compatible(findings, roles, compatible);
                break;
            case PantsAzureBlobProvider azure:
                ValidateAzure(findings, roles, azure);
                break;
            case PantsGcsProvider gcs:
                ValidateGcs(findings, roles, gcs);
                break;
            case PantsOciObjectStorageProvider oci:
    ...
    static void ValidateAws(
        ...
        ImmutableArray<PantsCloudStorageRole> roles,
        PantsAwsS3Provider provider)
    {
        if (!ValidAwsBucket(provider.Bucket))
        {
            findings.Add(Failure(
                PantsCloudProviderId.AwsS3,
                roles,
    ...
    static void ValidateS3Compatible(
        List<PantsCloudValidationFinding> findings,
        ImmutableArray<PantsCloudStorageRole> roles,
        PantsS3CompatibleProvider provider)
    {
    ...
    static void ValidateOci(
        List<PantsCloudValidationFinding> findings,
        ImmutableArray<PantsCloudStorageRole> roles,
        PantsOciObjectStorageProvider provider)
    {
        var kind = PantsCloudProviderId.OciObjectStorage;
    ...
    static void ValidateAzure(
        List<PantsCloudValidationFinding> findings,
        ImmutableArray<PantsCloudStorageRole> roles,
        PantsAzureBlobProvider provider)
    {
        var kind = PantsCloudProviderId.AzureBlob;
    ...
    static void ValidateGcs(
        List<PantsCloudValidationFinding> findings,
        ImmutableArray<PantsCloudStorageRole> roles,
        PantsGcsProvider provider)
    {
        var kind = PantsCloudProviderId.Gcs;
    ...
    internal static PantsCloudProviderId Kind(IPantsCloudProvider provider) => provider switch
    {
        PantsAwsS3Provider => PantsCloudProviderId.AwsS3,
        PantsS3CompatibleProvider => PantsCloudProviderId.S3Compatible,
        PantsAzureBlobProvider => PantsCloudProviderId.AzureBlob,
        PantsGcsProvider => PantsCloudProviderId.Gcs,
        PantsOciObjectStorageProvider => PantsCloudProviderId.OciObjectStorage,
        _ => provider.Id
    };
