...
enum Failpoint
{
    ...
    AfterWalSealRename,
    BeforeWalSealDirectorySync,
    BeforeWalReplacementWriterCreate,
    AfterWalReplacementWriterCreate,
    BeforeWalReplacementDirectorySync,
    AfterWalReplacementDirectorySync,
    BeforeWalPruneDirectorySync,
