...
public sealed class PantsConfigurationContractTests
{
    ...
    {
        PantsException memoryError = Assert.ThrowsAny<PantsException>(() => PantsOpenOptions
            .InMemory()
            .WithMemoryBudget(PantsMemoryBudget.FromBytes(2)));
        PantsException timeoutError = Assert.ThrowsAny<PantsException>(() => PantsOpenOptions
            .InMemory()
    ...
    public void ShouldModelThreeIndependentCloudLocations()
    {
        ...
        var control = new PantsCloudStorageLocation(
            ...
            "database-a");
        PantsCloudStorageTopology topology = PantsCloudStorageTopology.Shared(wal)
            .WithSst(sst)
            .WithControl(control);
        PantsOpenOptions options = PantsOpenOptions.CloudMulti("./cache", topology);
    ...
    public void ShouldRedactEveryInlineCloudSecretFromFormatting()
    {
        ...
        foreach ((object value, string sensitiveValue) in secrets)
        {
